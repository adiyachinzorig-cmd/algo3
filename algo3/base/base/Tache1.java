...
public class Tache1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (DblpPublicationGenerator gen = new DblpPublicationGenerator(xmlPath, dtdPath, 256)) {
            ...
            Communauté1 communauté = new Communauté1(1000000);
            while (pubCount < limit) {
                ...
                if (pubCount % 10000 == 0) {
                    ...
                    System.out.println("Nombre de communautés: " + communauté.getNbCommunautes());
                    System.out.println("Top 10 tailles: " + communauté.getTop10Tailles());
                }
